...
public class SecondActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ITEMS = "com.example.shoppinlist.extra.ITEMS";
    ...
    public void selectItem(View view) {
        ...
        switch (view.getId()) {
            case R.id.button_apple:
                return_items_intent.putExtra(EXTRA_ITEMS, "Apple");
            ...
            case R.id.button_sugar:
                return_items_intent.putExtra(EXTRA_ITEMS, "Suger");
                setResult(RESULT_OK, return_items_intent);
                finish();
                break;
            case R.id.button_wheat:
                return_items_intent.putExtra(EXTRA_ITEMS, "Wheat");
                setResult(RESULT_OK, return_items_intent);
                finish();
                break;
            default:
